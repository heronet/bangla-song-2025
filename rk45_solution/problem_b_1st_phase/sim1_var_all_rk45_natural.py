...
def find_all_solutions(target_distance, altitude, max_velocity=450,
    ...
    VELOCITY_RANGE_FINE = 10
    VELOCITY_STEP_FINE = 0.5
    ANGLE_RANGE_FINE = 3
    ANGLE_STEP_FINE = 0.2
...
def recommend_best_solution(solutions, criteria='practical'):
    ...
    if criteria == 'min_velocity':
        ...
        # prefer lower angles, shorter times, reasonable velocities
        best_score = float('inf')
        best = None

        for sol in solutions:
            angle_norm = sol['angle'] / 80
